...
class GameFunctions:
    ...
    def update_screen(ball, paddles, scoreboard, screen, settings):
        ...
        GameFunctions.display_center(screen, settings)
        scoreboard.show_scores()
        GameFunctions.update_paddles(ball, paddles)
        GameFunctions.update_ball(ball, scoreboard, settings)
    ...
    def check_events(settings):
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                GameFunctions.check_keydown_events(event, settings)
            elif event.type == pygame.KEYUP:
                GameFunctions.check_keyup_events(event, settings)
